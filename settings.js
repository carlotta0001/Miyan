...
global.owner = ['6283842288835'] //['628','628'] 2 owner atau lebih
global.packname = 'Bot WhatsApp'
global.author = 'Miyandev'
global.botname = 'Miyan Bot'
global.listprefix = ['/']
global.listv = ['•','●','■','✿','▲','➩','➢','➣','➤','✦','✧','△','❀','○','□','♤','♡','◇','♧','々','〆']
...
global.fake = {
	...
	thumbnail: fs.readFileSync('./src/media/miyan.png'),
	docs: fs.readFileSync('./src/media/fake.pdf'),
	listfakedocs: ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/vnd.openxmlformats-officedocument.presentationml.presentation','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/pdf'],
}

global.my = {
	yt: 'https://youtube.com/c/MiyanMontelli',
	gh: 'https://github.com/MiyanMontelli',
